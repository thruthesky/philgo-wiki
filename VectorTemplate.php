...
class VectorTemplate extends BaseTemplate {
	...
	public function execute() {
      ...
      <div id="ad-bottom">
        <div class="line1"><b>필고 컨설턴시</b> www.philgo.net</div>
        <div class="line4"><b>정직</b>과 <b>신뢰</b>로 고객의 믿음에 보답하겠습니다.</div>
		...
		<div id="mw-navigation">
			...
			<div id="mw-head">
				...
				<div id="philgo-logo">
					<a href="http://wiki.philgo.com/"><img src="http://philgo.com/etc/dokuwiki/lib/tpl/dokuwiki-philgo/images/logo-philgo.png"></a>
					<div class="philgo-title"><a href="http://wiki.philgo.com/">필리핀 정보 백과</a></div>
				</div>
				<div id="ad-top-right">
